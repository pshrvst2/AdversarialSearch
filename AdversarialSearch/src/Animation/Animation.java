...
public class Animation {
	...
	*/
	...
	public void fetchAndDrawSquareAssetsAndScores()
	{
		...
		StdDraw.setFont(_font);
		StdDraw.setPenColor(StdDraw.BLACK);
		String p1 = "" + _gameState.getP1().getPlayerId();
		String p2 = "" + _gameState.getP2().getPlayerId();
		String player1Score = ""+ _gameState.getP1().getScore();
		String player2Score = ""+ _gameState.getP2().getScore();
		
		StdDraw.text(1, 6.1, "Player 1 [" + p1 + "] : " + player1Score);
		StdDraw.text(5, 6.1, "Player 2 [" + p2 + "] : " + player2Score);
	}
